function [Params] = Analysis_Single_Palamede(directory,file,position)
...
%Analysis_Single_Palamede('THU_Single','Result_THU_04_Round1_WJJ.mat',1:8)
...
%legend(LP{8},{'0','45','90','135','180','225','270',' 315'});
%legend([LP{1},LP{2},LP{3},LP{4},LP{5},LP{6},LP{7},LP{8}],{'0','45','90','135','180','225','270',' 315'});
%% A remaining question in this function
%How to put up all the legends correctly?
